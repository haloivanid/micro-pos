export const NotificationBellIcon = () => {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M10 5.36658V8.14158" stroke="#444750" strokeWidth="1.25" strokeMiterlimit="10" strokeLinecap="round" />
      <path
      ...
      <path
        ...
        strokeMiterlimit="10"
      />
      <rect x="11.6668" y="0.833333" width="7.5" height="7.5" rx="3.75" fill="#AB73F2" />
      <rect x="11.6668" y="0.833333" width="7.5" height="7.5" rx="3.75" stroke="white" strokeWidth="1.66667" />
    </svg>
  );
};
